...
def test_sdk_create_tdf_with_builder():
    ...
    kas_info = KASInfo(url="https://example.kas.com", public_key=kas_public_key, kid="test-kid")
...
def test_validate_otdf_python_script():
    ...
    # Create KASInfo with public key
    kas_info = KASInfo(url="https://default.kas.example.com", public_key=kas_public_key, kid="test-kid")
