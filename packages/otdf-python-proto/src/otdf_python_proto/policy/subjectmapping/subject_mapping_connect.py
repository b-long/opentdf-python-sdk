...
class SubjectMappingServiceASGIApplication(ConnectASGIApplication[SubjectMappingService]):
    def __init__(self, service: SubjectMappingService | AsyncGenerator[SubjectMappingService], *, interceptors: Iterable[Interceptor]=(), read_max_bytes: int | None = None, compressions: Iterable[Compression] | None = None) -> None:
        super().__init__(
            service=service,
...
class SubjectMappingServiceWSGIApplication(ConnectWSGIApplication):
    def __init__(self, service: SubjectMappingServiceSync, interceptors: Iterable[InterceptorSync]=(), read_max_bytes: int | None = None, compressions: Iterable[Compression] | None = None) -> None:
        super().__init__(
            endpoints={
