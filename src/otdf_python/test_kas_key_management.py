...
class TestKASKeyManagement(unittest.TestCase):
    ...
    def test_rsa_key_generation(self):
        ...
        with patch('httpx.post') as mock_post:
            ...
            with patch('otdf_python.asym_decryption.AsymDecryption.decrypt', return_value=b'test_key'):
                # Call unwrap
                ...
                self.assertTrue(client.client_public_key.startswith('-----BEGIN PUBLIC KEY-----'))
    ...
    def test_ec_key_generation(self):
        ...
        with patch('otdf_python.eckeypair.ECKeyPair') as mock_ec_key_pair_class:
            ...
            mock_ec_key_pair.public_key_in_pem_format.return_value = "-----BEGIN PUBLIC KEY-----\nMOCKED_EC_KEY\n-----END PUBLIC KEY-----"
            ...
            with patch('httpx.post') as mock_post:
                ...
                with patch('otdf_python.aesgcm.AesGcm') as mock_aes_gcm_class:
                    ...
                    self.assertEqual(client.client_public_key,
                                     "-----BEGIN PUBLIC KEY-----\nMOCKED_EC_KEY\n-----END PUBLIC KEY-----")
                    ...
                    self.assertEqual(mock_ec_key_pair_class.call_args[1].get('curve_name'), 'P-256')
