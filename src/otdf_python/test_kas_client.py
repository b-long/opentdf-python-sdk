...
def test_unwrap_success(mock_asym_decryption, mock_crypto_utils, mock_post):
    ...
    mock_crypto_utils.generate_rsa_keypair.return_value = (mock_private_key, mock_public_key)
    ...
    # Mock HTTP response
    mock_resp = MagicMock()
    mock_resp.json.return_value = {'entityWrappedKey': 'd2VsY29tZQ=='}  # Base64 for "welcome"
    mock_resp.raise_for_status.return_value = None
