class SymmetricAndPayloadConfig:
    def __init__(self, cipher_type: int = 0, signature_ecc_mode: int = 0, has_signature: bool = True):
    ...
    def get_symmetric_and_payload_config_as_byte(self) -> int:
        ...
        return ((1 if self.has_signature else 0) << 7) | ((self.signature_ecc_mode & 0x07) << 4) | (self.cipher_type & 0x0F)
