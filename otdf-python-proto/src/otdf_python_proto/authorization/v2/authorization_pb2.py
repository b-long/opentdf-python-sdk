...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_ENTITYIDENTIFIER'].fields_by_name['entity_chain']._serialized_options = b'\272H\242\001\272\001\236\001\n\025entity_chain_required\0227entities must be provided and between 1 and 10 in count\032Lhas(this.entities) && this.entities.size() > 0 && this.entities.size() <= 10'
  ...
  _globals['_ENTITYIDENTIFIER'].fields_by_name['with_request_token']._loaded_options = None
  _globals['_ENTITYIDENTIFIER'].fields_by_name['with_request_token']._serialized_options = b'\272H\\\272\001Y\n\037with_request_token_must_be_true\022(with_request_token must be true when set\032\014this == true'
  ...
  _globals['_RESOURCE'].fields_by_name['attribute_values']._serialized_options = b'\272H\322\001\272\001\316\001\n\031attribute_values_required\022\\if provided, resource.attribute_values must be between 1 and 20 in count with all valid FQNs\032Sthis.fqns.size() > 0 && this.fqns.size() <= 20 && this.fqns.all(item, item.isUri())'
  ...
  _globals['_GETDECISIONREQUEST'].fields_by_name['fulfillable_obligation_fqns']._loaded_options = None
  _globals['_GETDECISIONREQUEST'].fields_by_name['fulfillable_obligation_fqns']._serialized_options = b'\272H\312\001\272\001\306\001\n\033obligation_value_fqns_valid\022^if provided, fulfillable_obligation_fqns must be between 1 and 50 in count with all valid FQNs\032Gthis.size() == 0 || (this.size() <= 50 && this.all(item, item.isUri()))'
  ...
  _globals['_GETDECISIONMULTIRESOURCEREQUEST'].fields_by_name['resources']._serialized_options = b'\272H\010\222\001\005\010\001\020\350\007'
  _globals['_GETDECISIONMULTIRESOURCEREQUEST'].fields_by_name['fulfillable_obligation_fqns']._loaded_options = None
  _globals['_GETDECISIONMULTIRESOURCEREQUEST'].fields_by_name['fulfillable_obligation_fqns']._serialized_options = b'\272H\312\001\272\001\306\001\n\033obligation_value_fqns_valid\022^if provided, fulfillable_obligation_fqns must be between 1 and 50 in count with all valid FQNs\032Gthis.size() == 0 || (this.size() <= 50 && this.all(item, item.isUri()))'
  ...
  _globals['_GETDECISIONBULKREQUEST'].fields_by_name['decision_requests']._loaded_options = None
  _globals['_GETDECISIONBULKREQUEST'].fields_by_name['decision_requests']._serialized_options = b'\272H\010\222\001\005\010\001\020\310\001'
  ...
  _globals['_DECISION']._serialized_start=3950
  _globals['_DECISION']._serialized_end=4026
  _globals['_ENTITYIDENTIFIER']._serialized_start=163
  _globals['_ENTITYIDENTIFIER']._serialized_end=810
  _globals['_ENTITYENTITLEMENTS']._serialized_start=813
  _globals['_ENTITYENTITLEMENTS']._serialized_end=1198
  _globals['_ENTITYENTITLEMENTS_ACTIONSLIST']._serialized_start=1012
  _globals['_ENTITYENTITLEMENTS_ACTIONSLIST']._serialized_end=1067
  _globals['_ENTITYENTITLEMENTS_ACTIONSPERATTRIBUTEVALUEFQNENTRY']._serialized_start=1070
  _globals['_ENTITYENTITLEMENTS_ACTIONSPERATTRIBUTEVALUEFQNENTRY']._serialized_end=1198
  _globals['_RESOURCE']._serialized_start=1201
  _globals['_RESOURCE']._serialized_end=1685
  _globals['_RESOURCE_ATTRIBUTEVALUES']._serialized_start=1636
  _globals['_RESOURCE_ATTRIBUTEVALUES']._serialized_end=1673
  _globals['_RESOURCEDECISION']._serialized_start=1688
  _globals['_RESOURCEDECISION']._serialized_end=1865
  _globals['_GETDECISIONREQUEST']._serialized_start=1868
  _globals['_GETDECISIONREQUEST']._serialized_end=2466
  _globals['_GETDECISIONRESPONSE']._serialized_start=2468
  _globals['_GETDECISIONRESPONSE']._serialized_end=2553
  _globals['_GETDECISIONMULTIRESOURCEREQUEST']._serialized_start=2556
  _globals['_GETDECISIONMULTIRESOURCEREQUEST']._serialized_end=3180
  _globals['_GETDECISIONMULTIRESOURCERESPONSE']._serialized_start=3183
  _globals['_GETDECISIONMULTIRESOURCERESPONSE']._serialized_end=3365
  _globals['_GETDECISIONBULKREQUEST']._serialized_start=3368
  _globals['_GETDECISIONBULKREQUEST']._serialized_end=3501
  _globals['_GETDECISIONBULKRESPONSE']._serialized_start=3503
  _globals['_GETDECISIONBULKRESPONSE']._serialized_end=3627
  _globals['_GETENTITLEMENTSREQUEST']._serialized_start=3630
  _globals['_GETENTITLEMENTSREQUEST']._serialized_end=3847
  _globals['_GETENTITLEMENTSRESPONSE']._serialized_start=3849
  _globals['_GETENTITLEMENTSRESPONSE']._serialized_end=3948
  _globals['_AUTHORIZATIONSERVICE']._serialized_start=4029
  _globals['_AUTHORIZATIONSERVICE']._serialized_end=4491
